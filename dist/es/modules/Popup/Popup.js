...
var Popup = function (_Component) {
  ...
  function Popup() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Popup.__proto__ || Object.getPrototypeOf(Popup)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.hideOnScroll = function () {
      ...
      eventStack.unsub('scroll', _this.hideOnScroll, { target: frame.contextWin });
      ...
      if (hideOnScroll) eventStack.sub('scroll', _this.hideOnScroll, { target: frame.contextWin });
...
Popup.handledProps = ['as', 'basic', 'children', 'className', 'content', 'flowing', 'frame', 'header', 'hideOnScroll', 'hoverable', 'inverted', 'offset', 'on', 'onClose', 'onMount', 'onOpen', 'onUnmount', 'position', 'size', 'style', 'trigger', 'wide'];
