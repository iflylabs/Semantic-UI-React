...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(CommentText, 'CommentText', 'src/views/Comment/CommentText.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/views/Comment/CommentText.js');
}();
