...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(FeedEvent, 'FeedEvent', 'src/views/Feed/FeedEvent.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/views/Feed/FeedEvent.js');
}();
