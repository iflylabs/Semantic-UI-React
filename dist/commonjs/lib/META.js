...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TYPES, 'TYPES', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(TYPE_VALUES, 'TYPE_VALUES', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isMeta, 'isMeta', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(getMeta, 'getMeta', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(metaHasKeyValue, 'metaHasKeyValue', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isType, 'isType', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isAddon, 'isAddon', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isCollection, 'isCollection', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isElement, 'isElement', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isView, 'isView', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isModule, 'isModule', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isParent, 'isParent', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isChild, 'isChild', 'src/lib/META.js');

  __REACT_HOT_LOADER__.register(isPrivate, 'isPrivate', 'src/lib/META.js');
}();
