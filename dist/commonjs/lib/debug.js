...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_debug, '_debug', 'src/lib/debug.js');

  __REACT_HOT_LOADER__.register(noop, 'noop', 'src/lib/debug.js');

  __REACT_HOT_LOADER__.register(makeDebugger, 'makeDebugger', 'src/lib/debug.js');

  __REACT_HOT_LOADER__.register(debug, 'debug', 'src/lib/debug.js');
}();
