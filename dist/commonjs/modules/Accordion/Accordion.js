...
var Accordion = function (_Component) {
  ...
  function Accordion() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Accordion.__proto__ || Object.getPrototypeOf(Accordion)).call.apply(_ref, [this].concat(args))), _this), _this.handleTitleClick = function () {
      var _this2;

      return (_this2 = _this).__handleTitleClick__REACT_HOT_LOADER__.apply(_this2, arguments);
    }, _this.isIndexActive = function () {
      var _this3;

      return (_this3 = _this).__isIndexActive__REACT_HOT_LOADER__.apply(_this3, arguments);
    }, _this.renderChildren = function () {
      var _this4;

      return (_this4 = _this).__renderChildren__REACT_HOT_LOADER__.apply(_this4, arguments);
    }, _this.renderPanels = function () {
      var _this5;

      return (_this5 = _this).__renderPanels__REACT_HOT_LOADER__.apply(_this5, arguments);
  ...
  (0, _createClass3.default)(Accordion, [{
    ...
    key: '__handleTitleClick__REACT_HOT_LOADER__',
    value: function __handleTitleClick__REACT_HOT_LOADER__(e, index) {
    ...
    key: '__isIndexActive__REACT_HOT_LOADER__',
    value: function __isIndexActive__REACT_HOT_LOADER__(index) {
    ...
    key: '__renderChildren__REACT_HOT_LOADER__',
    value: function __renderChildren__REACT_HOT_LOADER__() {
      var _this6 = this;
      ...
      return _react.Children.map(children, function (child) {
        ...
        if (isTitle) {
          ...
          var isActive = (0, _has3.default)(child, 'props.active') ? child.props.active : _this6.isIndexActive(titleIndex);
          var onClick = function onClick(e) {
            _this6.handleTitleClick(e, currentIndex);
        ...
        if (isContent) {
          var _isActive = (0, _has3.default)(child, 'props.active') ? child.props.active : _this6.isIndexActive(contentIndex);
          contentIndex += 1;
    ...
    key: '__renderPanels__REACT_HOT_LOADER__',
    value: function __renderPanels__REACT_HOT_LOADER__() {
      var _this7 = this;
      ...
      (0, _each3.default)(panels, function (panel, i) {
        var isActive = (0, _has3.default)(panel, 'active') ? panel.active : _this7.isIndexActive(i);
        var onClick = function onClick(e) {
          _this7.handleTitleClick(e, i);
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(Accordion, 'Accordion', 'src/modules/Accordion/Accordion.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/modules/Accordion/Accordion.js');
}();
