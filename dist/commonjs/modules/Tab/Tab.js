...
var Tab = function (_Component) {
  ...
  function Tab() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Tab.__proto__ || Object.getPrototypeOf(Tab)).call.apply(_ref, [this].concat(args))), _this), _this.handleItemClick = function () {
      var _this2;

      return (_this2 = _this).__handleItemClick__REACT_HOT_LOADER__.apply(_this2, arguments);
  ...
  (0, _createClass3.default)(Tab, [{
    ...
    value: function __handleItemClick__REACT_HOT_LOADER__(e, _ref2) {
      ...
      (0, _invoke3.default)(this.props, 'onTabChange', e, (0, _extends3.default)({}, this.props, { activeIndex: index }));
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(Tab, 'Tab', 'src/modules/Tab/Tab.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/modules/Tab/Tab.js');
}();
