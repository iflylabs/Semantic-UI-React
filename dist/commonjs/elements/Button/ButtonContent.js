...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ButtonContent, 'ButtonContent', 'src/elements/Button/ButtonContent.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/elements/Button/ButtonContent.js');
}();
